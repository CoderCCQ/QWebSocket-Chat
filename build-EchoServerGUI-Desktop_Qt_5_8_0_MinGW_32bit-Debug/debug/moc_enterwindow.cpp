...
#include "../../EchoServerGUI/enterwindow.h"
...
const QMetaObject EnterWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EnterWindow.data,
      qt_meta_data_EnterWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *EnterWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_EnterWindow.stringdata0))
        return static_cast<void*>(const_cast< EnterWindow*>(this));
